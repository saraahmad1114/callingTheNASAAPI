    ...
    func getAsteriodInformationWithCompletion (startDate: String, endData: String, completion: (NSArray)->()){
        ...
        NASAAPIClient.getAsteriodInformationWith(startDate, endData: endData) { (nasaDictionary) in
            ...
            for singleDictionary in unwrappedDate {
                ...
                let asteriodObject = Asteriod.init(name: unwrappedName, absoluteMagnitude: unwrappedAbsoluteMagnitude, neoReference: unwrappedNeoReferenceId, estimatedMileMin: unwrappedestimatedDiameterMin, estimatedMileMax: unwrappedestimatedDiameterMax)
